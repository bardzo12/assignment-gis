 ...
 */
public class AddSegmentTime extends UseCase {

    private final Repository repository;

    private Token token;

    public AddSegmentTime(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, Repository repository) {
        ...
        this.subscription = this.repository.getToken()
                ...
                .subscribe(new TokenSubscriber(new TokenSubscriber.SubscriberListener() {
                    ...
                    public void onCompleted() {
                        AddSegmentTime.super.execute(useCaseSubscriber);
                    }
                    ...
                    public void onNext(Token token) {
                        AddSegmentTime.this.token = token;
                    }
                }));
    }
}

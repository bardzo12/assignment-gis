...
import sk.pixwell.therun.data.cache.serializer.Serializer;
import sk.pixwell.therun.domain.executor.ThreadExecutor;

/**
 * {@link MapCache} implementation.
 */
@Singleton
public class MapCacheImpl implements MapCache {
  ...
  private static final String DEFAULT_FILE_NAME = "map_";
  ...
  /**
   * Constructor of the class {@link MapCacheImpl}.
   *
   * @param context A
   ...
   */
  @Inject
  MapCacheImpl(Context context, Serializer serializer,

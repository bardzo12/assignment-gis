 ...
 */
public class StartRun extends UseCase {
    ...
    public StartRun(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, Repository repository) {
    ...
    protected Observable buildUseCaseObservable() {
        return this.repository.startRun(token, time, type);

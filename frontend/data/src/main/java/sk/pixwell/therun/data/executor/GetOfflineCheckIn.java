 ...
 */
public class GetOfflineCheckIn extends UseCase {


    private final Repository repository;

    public GetOfflineCheckIn(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, Repository repository) {
    ...
    protected Observable buildUseCaseObservable() {
        return this.repository.getOfflineCheckIn();
    }
}

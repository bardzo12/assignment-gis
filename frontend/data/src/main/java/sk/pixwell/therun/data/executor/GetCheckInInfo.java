 ...
 */
public class GetCheckInInfo extends UseCase {

    private final Repository repository;

    private Token token;

    public GetCheckInInfo(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, Repository repository) {
    ...
    protected Observable buildUseCaseObservable() {
        return this.repository.getCheckInInfo(token);
        ...
        this.subscription = this.repository.getToken()
                ...
                .subscribe(new TokenSubscriber(new TokenSubscriber.SubscriberListener() {
                    ...
                    public void onCompleted() {
                        GetCheckInInfo.super.execute(useCaseSubscriber);
                    }
                    ...
                    public void onNext(Token token) {
                        GetCheckInInfo.this.token = token;
                    }
                }));
    }
}

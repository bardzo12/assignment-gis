 ...
 */
public class GetTeamSegments extends UseCase {

    private final Repository repository;

    private Token token;

    public GetTeamSegments(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, Repository repository) {
    ...
    protected Observable buildUseCaseObservable() {
        return this.repository.getTeamSegments(token);
        ...
        this.subscription = this.repository.getToken()
                ...
                .subscribe(new TokenSubscriber(new TokenSubscriber.SubscriberListener() {
                    ...
                    public void onCompleted() {
                        GetTeamSegments.super.execute(useCaseSubscriber);
                    }
                    ...
                    public void onNext(Token token) {
                        GetTeamSegments.this.token = token;
                    }
                }));
    }
}

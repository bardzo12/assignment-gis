 ...
 */
public class GetLandUse extends UseCase {

    private final Repository repository;
    private Subscriber<List<Landuse>> useCaseSubscriber;

    private Stage points;

    public GetLandUse(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, Repository repository) {
    ...
    protected Observable buildUseCaseObservable() {
        return this.repository.getLandUse(points);

    }

    public void execute(final Subscriber<List<Landuse>> useCaseSubscriber, Stage points) {
        this.points = points;
                ...
                this.subscription = this.repository.getToken()
                        ...
                        .subscribe(new TokenSubscriber(new TokenSubscriber.SubscriberListener() {
                            ...
                            public void onError(final Throwable e) {
                                Observable.create((Observable.OnSubscribe<List<Landuse>>) subscriber ->

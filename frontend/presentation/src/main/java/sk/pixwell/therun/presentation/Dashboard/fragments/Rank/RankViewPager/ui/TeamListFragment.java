 ...
 */
public class TeamListFragment extends TheRunFragment implements TeamListView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_team_list, container, false);
    ...
    public void setList(List<Team> teamsList) {
        ...
        TeamAdapter newsFeedAdapter = new TeamAdapter(getContext(), teamsList, mListener, false);
    ...
    public void changeFavorite() {
        ...
        dashboardActivity.changeFavoriteInTeamsFragment();
    }
